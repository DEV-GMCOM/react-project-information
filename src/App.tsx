...
// 새로운 페이지들
import BiddingPage from './pages/information/BiddingPage';
  ...
  return (
      <Layout>
        <Routes>
          ...
          {/* 정보수집 */}
          <Route path="/information/bidding" element={<BiddingPage />} />
          <Route path="/information/advertiser" element={<AdvertiserPage />} />
